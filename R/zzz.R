...
.onAttach <- function(libname, pkgname) {
  ...
  if (dir.exists(lock_dir)) {
    packageStartupMessage(
      ...
      "This may cause installation issues. Run ggpubrplus::clean_lock_files() to remove it."
    )
  }
}
...
#'   Default is "ggpubrplus". Use "all" to remove all lock files.
